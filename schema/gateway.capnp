...
struct RegisterAgentResponse {
    ...
    properties @0 :List(Property);
    # error contains a description of the error if registration fails, or an empty string on success.
    error      @1 :Text;
}
...
struct UnregisterAgentResponse {
    ...
    properties @0 :List(Property);
    # error contains a description of the error if unregistration fails, or an empty string on success.
    error      @1 :Text;
}
