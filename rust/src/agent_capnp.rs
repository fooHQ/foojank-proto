...
pub mod start_worker_request {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 72] = [
      ...
      ::capnp::word(87, 9, 0, 0, 105, 10, 0, 0),
...
pub mod start_worker_response {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 34] = [
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(186, 10, 0, 0, 90, 11, 0, 0),
...
pub mod stop_worker_request {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 18] = [
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(178, 11, 0, 0, 205, 11, 0, 0),
...
pub mod stop_worker_response {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 34] = [
      ...
      ::capnp::word(1, 0, 7, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(28, 12, 0, 0, 186, 12, 0, 0),
      ::capnp::word(21, 0, 0, 0, 250, 0, 0, 0),
      ::capnp::word(33, 0, 0, 0, 7, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(29, 0, 0, 0, 63, 0, 0, 0),
...
pub mod update_worker_status {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 49] = [
      ...
      ::capnp::word(1, 0, 7, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(24, 13, 0, 0, 21, 14, 0, 0),
      ::capnp::word(21, 0, 0, 0, 250, 0, 0, 0),
      ::capnp::word(33, 0, 0, 0, 7, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
...
pub mod update_worker_stdio {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 34] = [
      ...
      ::capnp::word(1, 0, 7, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(135, 14, 0, 0, 210, 14, 0, 0),
      ::capnp::word(21, 0, 0, 0, 242, 0, 0, 0),
      ::capnp::word(33, 0, 0, 0, 7, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(29, 0, 0, 0, 63, 0, 0, 0),
...
pub mod update_client_info {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 81] = [
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(27, 15, 0, 0, 143, 16, 0, 0),
...
pub mod message {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 26] = [
      ...
      ::capnp::word(1, 0, 7, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(207, 16, 0, 0, 91, 18, 0, 0),
