...
pub mod envelope {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_payload(self) -> ::capnp::Result<crate::agent_capnp::message::Reader<'a>> {
      ::capnp::traits::FromPointerReader::get_from_pointer(&self.reader.get_pointer_field(1), ::core::option::Option::None)
    }
    #[inline]
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn get_payload(self) -> ::capnp::Result<crate::agent_capnp::message::Builder<'a>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(1), ::core::option::Option::None)
    }
    #[inline]
    pub fn set_payload(&mut self, value: crate::agent_capnp::message::Reader<'_>) -> ::capnp::Result<()> {
      ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(1), value, false)
    }
    #[inline]
    pub fn init_payload(self, ) -> crate::agent_capnp::message::Builder<'a> {
  ...
  impl Pipeline  {
    pub fn get_payload(&self) -> crate::agent_capnp::message::Pipeline {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 48] = [
      ::capnp::word(0, 0, 0, 0, 6, 0, 6, 0),
      ::capnp::word(68, 35, 219, 150, 61, 248, 213, 241),
      ::capnp::word(12, 0, 0, 0, 1, 0, 0, 0),
      ::capnp::word(112, 139, 170, 54, 93, 170, 204, 220),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(97, 103, 101, 110, 116, 46, 99, 97),
      ::capnp::word(112, 110, 112, 58, 69, 110, 118, 101),
      ::capnp::word(108, 111, 112, 101, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 1, 0, 1, 0),
      ::capnp::word(8, 0, 0, 0, 3, 0, 4, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 1, 0, 0, 0, 0, 0),
    ...
    pub fn get_field_types(index: u16) -> ::capnp::introspect::Type {
      match index {
        0 => <::capnp::text::Owned as ::capnp::introspect::Introspect>::introspect(),
        1 => <crate::agent_capnp::message::Owned as ::capnp::introspect::Introspect>::introspect(),
        _ => ::capnp::introspect::panic_invalid_field_index(index),
      }
    }
    pub fn get_annotation_types(child_index: Option<u16>, index: u32) -> ::capnp::introspect::Type {
    ...
    pub static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
    pub static MEMBERS_BY_NAME : &[u16] = &[1,0];
    pub const TYPE_ID: u64 = 0xf1d5_f83d_96db_2344;
  }
}
