...
func CmdRegisterAgentSubject(gatewayID, agentID string) string {
	return utils.FormatString(capnp.CmdRegisterT, gatewayID, agentID)
}
...
func CmdUnregisterAgentSubject(gatewayID, agentID string) string {
	return utils.FormatString(capnp.CmdUnregisterT, gatewayID, agentID)
}
...
func EvtRegisterAgentSubject(gatewayID, agentID string) string {
	return utils.FormatString(capnp.EvtRegisterT, gatewayID, agentID)
}
...
func EvtUnregisterAgentSubject(gatewayID, agentID string) string {
	return utils.FormatString(capnp.EvtUnregisterT, gatewayID, agentID)
}
